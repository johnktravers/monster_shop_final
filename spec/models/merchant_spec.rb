...
describe Merchant, type: :model do
  ...
  describe 'instance methods' do
    before(:each) do
      ...
      @address_1 = @user.addresses.create!(nickname: 'Home', address: "123 Lincoln St", city: "Denver", state: "CO", zip: '80203')
      @address_2 = @user.addresses.create!(nickname: 'Work', address: "1482 Main St", city: "Hershey", state: "PA", zip: '53852')
    end
    it 'no_orders' do
    ...
    it 'pending_orders' do
      order_1 = Order.create!(address_id: @address_1.id, status: 3)
      order_2 = Order.create!(address_id: @address_2.id)
      order_3 = Order.create!(address_id: @address_1.id)
      order_1.item_orders.create!(item: @tire, price: @tire.price, quantity: 2)
      order_2.item_orders.create!(item: @chain, price: @chain.price, quantity: 2)
  ...
  describe 'class methods' do
    it 'can get all orders pertaining to a merchant' do
      ...
      address_1 = user_1.addresses.create!(nickname: 'Home', address: '123 Main Street', city: 'Greenville', state: 'NC', zip: '29583')
      order_1 = address_1.orders.create!
      order_1.item_orders.create!(item_id: @tire.id, quantity: 2, price: 50)

      user_2 = User.create!(name: "Gmoney", email: "test@gmail.com", password: "password123", password_confirmation: "password123")
      address_2 = user_2.addresses.create!(nickname: 'Home', address: "123 Lincoln St", city: "Denver", state: "CO", zip: '80203')
      ...
      address_3 = user_3.addresses.create!(nickname: 'Work', address: '456 2nd Street', city: 'Redville', state: 'SC', zip: '29444')
